...
export const en = {
  ...
  suggestions: {
    ...
    heroSubtitle: "Every suggestion earns you +10 XP.\nIf it becomes a module, you earn even more.",
    heroXpLabel: "per suggestion",
    heroXpBonus: "Popular suggestions earn +75 XP",
    ...
    createSuccess: "Suggestion submitted! +10 XP",
    noSuggestions: "No suggestions yet.",
    beFirst: "Be the first — submit an idea and earn +10 XP!",
    sortPopular: "Popular",
    sortNewest: "Newest",
    backToList: "Back to suggestions",
    authorXp: "+10 XP author",
    popularBadge: "+75 XP – popular suggestion",
    approve: "Approve",
    reject: "Reject",
