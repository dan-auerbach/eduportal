...
export const en = {
  ...
  notifications: {
    ...
    typeXpEarned: "XP earned",
    typeRewardApproved: "Reward approved",
    typeRewardRejected: "Reward rejected",
    typeSuggestionPopular: "Popular suggestion",
    typeSuggestionStatus: "Suggestion status",
    typeModuleExpiring: "Module expiring soon",
    typeModuleExpired: "Module expired",
    typeAttendanceConfirmed: "Attendance confirmed",
    typeAttendanceReminder: "Attendance reminder",
    moduleExpiring: "Expiring soon: {title}",
    moduleExpiringMessage: "Your \"{title}\" certification expires in {days} days. Renew it on time.",
    moduleExpired: "Module expired: {title}",
    moduleExpiredMessage: "Your \"{title}\" certification has expired. You need to complete it again.",
  },
  ...
  admin: {
    ...
    editor: {
      ...
      // AI Editor
      aiGenerateMetadata: "Generate with AI",
      aiGenerating: "AI generating...",
      aiSuggestionTitle: "AI Suggestion",
      aiSuggestionApply: "Apply suggestion",
      aiSuggestionDiscard: "Discard",
      aiRateLimited: "Too many AI requests. Try again in a minute.",
      aiError: "AI generation failed. Try again.",
      aiGenerateTags: "AI Tags",
      aiTagsGenerating: "AI generating tags...",
      aiTagsGenerated: "{count} tags added",
      aiGenerateQuiz: "AI Quiz",
      aiQuizGenerating: "AI generating quiz...",
      aiQuizGenerated: "AI quiz created with {count} questions",
      aiQuizNoContent: "Add content to sections before generating an AI quiz",
      aiGenerateImage: "AI Image",
      aiImageGenerating: "AI generating image (~15s)...",
      aiImageGenerated: "AI cover image generated",
      aiImageNotConfigured: "AI image generation not configured (missing OPENAI_API_KEY)",
      // Quality checks
      publishCheckTitle: "Knowledge title is required",
      publishCheckDescription: "Knowledge description is required",
      publishCheckSections: "Knowledge must have at least one section",
      estimateTime: "Calculate",
      // Mentors
      mentorSearch: "Search mentors...",
      mentorNoResults: "No results",
      mentorSelected: "{count} selected",
      mentors: "Mentors",
  ...
  mentorLive: {
    ...
    physicalLocationField: "Physical location",
    physicalLocationPlaceholder: "e.g. Conference Room A, 123 Main St",
    materials: "Materials",
    addMaterial: "Add material",
    removeMaterial: "Remove material",
    visibleBeforeEvent: "Visible before event",
    ...
    bulkConfirm: "Confirm all attendees",
    revokeAttendance: "Revoke attendance",
    attendees: "Attendees",
    noAttendees: "No registered attendees",
    statusRegistered: "Registered",
    statusCancelled: "Cancelled",
    statusAttended: "Attended",
    statusNoShow: "No show",
    attendanceConfirmed: "Attendance confirmed",
    attendanceRevoked: "Attendance revoked",
    xpAwardedForAttendance: "+20 XP for attendance",
  },
  ...
  gamification: {
    leaderboard: "Leaderboard",
    leaderboardSubtitle: "Compare your progress with other users.",
    allGroups: "All groups",
    noEntries: "No leaderboard data yet.",
    you: "you",
    xp: "XP",
    rank: "Rank",
    rankVajenec: "Apprentice",
    rankPomocnik: "Assistant",
    rankMojster: "Master",
    rankMentor: "Mentor",
    nextRank: "Next rank",
  },
  ...
  rewards: {
    title: "Rewards",
    subtitle: "Redeem your XP points for rewards.",
    adminTitle: "Manage Rewards",
    adminSubtitle: "Create and manage the reward catalog.",
    ...
    confirmRedeemMessage: "Are you sure you want to redeem \"{title}\" for {cost} XP?",
    confirmRedeemAction: "Redeem Reward",
    requiresApproval: "This reward requires administrator approval.",
    ...
    // Storefront
    storefront: "Store",
    storefrontSubtitle: "Redeem your XP points for rewards and perks.",
    missingXp: "You need {xp} more XP for \"{title}\"",
    missingXpShort: "You need {xp} more XP",
    popular: "Popular",
    limited: "Limited",
    exclusive: "Exclusive",
    monthlyUsage: "{used}/{limit} monthly",
    availableStock: "Stock: {count}",
    unlimitedStock: "Unlimited",
    viewHistory: "Redemption history",
    monthlyLimitReached: "Monthly limit reached",
    cantAfford: "Not enough XP",
    yourBalance: "Your balance",
    redemptionHistory: "Redemption History",
    redemptionHistorySubtitle: "View your past reward redemptions.",
  ...
  suggestions: {
    title: "Suggest Knowledge",
    subtitle: "Shape your company's future knowledge.\nSuggest an idea, collect votes and earn XP.",
    heroTitle: "Got an idea for new knowledge?",
    heroSubtitle: "Every suggestion earns you +{xpCreated} XP.\nIf it becomes a module, you earn even more.",
    heroXpLabel: "per suggestion",
    heroXpBonus: "Popular suggestions earn +{xpTop} XP",
    adminTitle: "Manage Suggestions",
    adminSubtitle: "Review and moderate knowledge suggestions.",
    newSuggestion: "New Suggestion",
    titleField: "Title",
    titlePlaceholder: "E.g. Introduction to Agile Methodologies",
    descriptionField: "Description",
    descriptionPlaceholder: "Describe why this knowledge would be valuable...",
    linkField: "Link (optional)",
    anonymous: "Submit anonymously",
    submit: "Submit (+{xp} XP)",
    submitHelper: "XP is awarded immediately after submission.",
    createSuccess: "Suggestion submitted! +{xp} XP",
    noSuggestions: "No suggestions yet.",
    beFirst: "Be the first — submit an idea and earn XP!",
    sortPopular: "Popular",
    sortNewest: "Newest",
    backToList: "Back to suggestions",
    authorXp: "+{xp} XP author",
    popularBadge: "+{xp} XP – popular suggestion",
    approve: "Approve",
    reject: "Reject",
  ...
  manager: {
    ...
    subtitle: "Overview of learning progress and risks.",
    allGroups: "All groups",
    usersAtRisk: "Users at Risk",
    avgEngagement: "Avg. Engagement",
    completionRate: "Completion Rate",
    activeSuggestions: "Open Suggestions",
    riskUsers: "Overdue Users",
    noRiskUsers: "No users are overdue.",
    overdue: "overdue",
    topPerformers: "Top Performers",
    noPerformers: "No data available.",
  ...
  compliance: {
    ...
    subtitle: "Track certificate validity and required renewals.",
    expiringCount: "Expiring Soon",
    expiredCount: "Expired",
    expiringSoon: "Expiring in 30 days",
    noExpiring: "No certificates expiring soon.",
    expired: "Expired Certificates",
    noExpired: "No expired certificates.",
    daysLeft: "days",
    expiredDaysAgo: "Expired {days} days ago",
    reassign: "Reassign",
    reassigned: "Module successfully reassigned for renewal.",
  },
} as const;
